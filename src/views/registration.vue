...
<template>
    <div class="regf">
        <form class="regform">
            ...
            <input type="text" placeholder="First Name" class="regform-placeholder">
            <input type="text" placeholder="Last Name" class="regform-placeholder">
            ...
            <input type="text" placeholder="Email" class="regform-placeholder">
            <input type="text" placeholder="Password" class="regform-placeholder">
